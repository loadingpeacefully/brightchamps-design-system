...
>
  ...
  // ═══════════════════════════════════════════════════════════════════
  // newDashboard ATOMS (14) — built 2026-04-28
  // ═══════════════════════════════════════════════════════════════════

  {
    name: 'Icon (atom)', slug: 'icon-atom',
    description: 'Wrapper around NextImage with CDN URL. Props: path, width=24, height=24, alt, style. Production loads from src/constants/images.tsx (217 _ICON exports). Figma component is a 24×24 placeholder.',
    variants: ['default'],
    tokens: [
      { property: 'Default size', token: 'icon/size/lg', cssVar: '--icon-size-lg', value: '24px' },
      { property: 'Placeholder bg', token: 'surface/bg/sunken', cssVar: '--surface-bg-sunken', value: 'neutral-100' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/Icon/index.tsx',
    target: 'newDashboard',
    verificationStatus: 'verified',
    usageExample: '<Icon path={GEMS_ICON} width={20} height={20} alt="Gems" />',
  },
  {
    name: 'LoadingIndicator', slug: 'loading-indicator',
    description: 'Animated trophy loader (memoized). Props: type=\'app\'|\'layout\'. Uses motion/duration/crawl + animation/spin preset.',
    variants: ['app', 'layout'],
    tokens: [
      { property: 'Surface', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Loader bg', token: 'surface/bg/brand/subtle', cssVar: '--surface-bg-brand-subtle', value: '#FAF5FF' },
      { property: 'Animation', token: 'animation/spin/duration + animation/spin/easing', cssVar: '—', value: '1500ms linear' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/LoadingIndicator/index.tsx',
    target: 'newDashboard',
    verificationStatus: 'verified',
    usageExample: '<LoadingIndicator type="app" />',
  },
  {
    name: 'ProgressBar (atom)', slug: 'progress-bar-atom',
    description: 'newDashboard progress-bar atom with traffic-light colors. Props: progressPercent, color=\'green\'|\'red\'|\'yellow\' (default yellow). DIFFERENT from legacy /components/ProgressBar — verify usage before deprecating either.',
    variants: ['green', 'yellow', 'red'],
    tokens: [
      { property: 'Track height', token: '—', cssVar: '—', value: '8px (source-exact, no token)' },
      { property: 'Track bg', token: 'surface/bg/disabled', cssVar: '--surface-bg-disabled', value: 'neutral-100 (source: #ebebeb)' },
      { property: 'Fill (green)', token: 'surface/bg/success', cssVar: '--surface-bg-success', value: '#00B67A (source: #40c178, drift)' },
      { property: 'Fill (yellow)', token: 'surface/bg/warning', cssVar: '--surface-bg-warning', value: '#FF7C35 (source: #ffbf31, drift)' },
      { property: 'Fill (red)', token: 'surface/bg/error', cssVar: '--surface-bg-error', value: '#FF5C5C (source: #ff6565, drift)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/ProgressBar/progressBar.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: [
      'newDashboard atom uses traffic-light colors (#40c178/#ffbf31/#ff6565) that don\'t exactly match the canonical surface/bg/success/warning/error. Bound to nearest semantic; flag as DC-021 candidate.',
      'Legacy src/components/ProgressBar uses brand-purple/success-green/warning-orange palette — completely different visual identity. Two parallel ProgressBar implementations.',
    ],
  },
  {
    name: 'ProgressbarWithStar', slug: 'progress-bar-with-star',
    description: 'Composite of ProgressBar + StarRating. Props: progress, barColor=#EFF3F5, progressColor=#4BAE4F, starColor. Star follows progress fill. 17px tall, 8.5px radius (= pill at this height).',
    variants: ['default'],
    tokens: [
      { property: 'Height', token: '—', cssVar: '—', value: '17px (source-exact)' },
      { property: 'Radius', token: 'radius/pill', cssVar: '--radius-pill', value: 'pill (source: 8.5px = full at this height)' },
      { property: 'Bar bg', token: 'surface/bg/disabled', cssVar: '--surface-bg-disabled', value: 'neutral-100' },
      { property: 'Fill', token: 'surface/bg/success', cssVar: '--surface-bg-success', value: '#00B67A (source: #4BAE4F)' },
      { property: 'Star color', token: 'surface/bg/accent', cssVar: '--surface-bg-accent', value: '#FFCE00 (source: #B9B9B9 default — gray)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/ProgressbarWithStar/index.tsx',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'SelectedTeacher (atom)', slug: 'selected-teacher',
    description: 'Teacher selection card. Props: name, rating, gender, experience, avatar, country, languages. Uses react-simple-star-rating with fillColor="#FFC200" (DC-017 candidate).',
    variants: ['default'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Border', token: 'border/brand', cssVar: '--border-brand', value: '#722ED1 (source uses #4e3bc2 + #e1e2ff)' },
      { property: 'Star fill', token: 'surface/bg/accent', cssVar: '--surface-bg-accent', value: '#FFCE00 (source: #FFC200 — DC-017)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/SelectedTeacher/selectedTeacher.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'ShowStarRating', slug: 'show-star-rating',
    description: 'Inline-SVG star rating. Props: rating, color, width, height, starType=\'default\'|\'shiny\', showUnhighlightedStar, onStarClick. Two starType options (default + shiny). Uses animation/star preset.',
    variants: ['default', 'shiny'],
    tokens: [
      { property: 'Filled star', token: 'surface/bg/accent', cssVar: '--surface-bg-accent', value: '#FFCE00 (default per usage)' },
      { property: 'Empty star', token: 'surface/bg/disabled', cssVar: '--surface-bg-disabled', value: 'neutral-100' },
      { property: 'Animation', token: 'animation/star/duration + animation/star/easing', cssVar: '—', value: '500ms ease-in-out' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/ShowStarRating/index.tsx',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'SideBarPopup', slug: 'sidebar-popup',
    description: 'Portal-rendered sidebar popup with backdrop + close button. Props: children, handleClose, customWidth, customCss, closeButtonAbsolute, backDropClose.',
    variants: ['default'],
    tokens: [
      { property: 'Backdrop', token: 'surface/bg/overlay', cssVar: '--surface-bg-overlay', value: 'rgba(0,0,0,0.5)' },
      { property: 'Sidebar bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Sidebar shadow', token: 'shadow/lg effect style', cssVar: '—', value: '0 10px 15px -3px rgba(0,0,0,0.1)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/SideBarPopup/index.tsx',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'SpeechBubble', slug: 'speech-bubble',
    description: 'Speech bubble for BrightBuddy AI. Props: text, position=\'left\'|\'right\', cornerPosition=\'center\'|\'left\'|\'right\', width, isOpen, setIsInfoOpen.',
    variants: ['left', 'right'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Border', token: 'border/subtle', cssVar: '--border-subtle', value: 'neutral-100 (source: #e0e0e0)' },
      { property: 'Radius', token: 'radius/control/lg', cssVar: '--radius-control-lg', value: '10px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/SpeechBubble/speechBubble.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'TextTruncate', slug: 'text-truncate',
    description: 'Text truncation with read-more toggle. Props: text, maxLength=100, showReadMore, expandable, readMoreText, readLessText, fixedWidth. CONFLICT: source SCSS uses Bootstrap blues — DC-020 candidate.',
    variants: ['default'],
    tokens: [
      { property: 'Body text', token: 'text/default', cssVar: '--text-default', value: 'neutral-900' },
      { property: 'Read-more link', token: 'text/info', cssVar: '--text-info', value: '#33CCFF (source: #007bff Bootstrap blue — DC-020)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/TextTruncate/textTruncate.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: [
      'Source SCSS uses 6 Bootstrap CSS framework blues (#007bff, #0056b3, #3182ce, #63b3ed, #6c757d, #a0aec0). DC-020 candidate — these have no place in BrightChamps.',
    ],
  },
  {
    name: 'Tooltip', slug: 'tooltip',
    description: 'Portal-rendered tooltip with auto-positioning. Props: content, trigger=\'click\'|\'hover\', imageUrl, imageWidth, imageHeight. Source bg #FFF5F1 (peach) bound to surface/bg/warning/subtle.',
    variants: ['hover', 'click'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/warning/subtle', cssVar: '--surface-bg-warning-subtle', value: '#FFF5EF (source: #FFF5F1 peach)' },
      { property: 'Shadow', token: 'shadow/md effect style', cssVar: '—', value: '0 4px 6px -1px rgba(0,0,0,0.1)' },
      { property: 'Radius', token: 'radius/control/sm', cssVar: '--radius-control-sm', value: '6px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/Tooltip/tooltip.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'TruncateText', slug: 'truncate-text',
    description: 'Smaller sibling of TextTruncate. Props: text, maxLength=80, read_less, read_more (i18n props). DC-028 candidate: recommend deprecating one or merging.',
    variants: ['default'],
    tokens: [
      { property: 'Body text', token: 'text/default', cssVar: '--text-default', value: 'neutral-900' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/TruncateText/truncateText.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: [
      'Two near-identical truncation atoms (TextTruncate + TruncateText) coexist with different APIs and styling. DC-028 candidate: deprecate one or merge into a single canonical atom.',
    ],
  },
  {
    name: 'DateDropdown', slug: 'date-dropdown',
    description: 'Native date input wrapped with custom UI. Props: label, minDate, maxDate, onChange, isDisabled, value. Uses dayjs MMM DD, YYYY format.',
    variants: ['default'],
    tokens: [
      { property: 'Field bg', token: 'surface/bg/subtle', cssVar: '--surface-bg-subtle', value: 'neutral-50' },
      { property: 'Border', token: 'border/subtle', cssVar: '--border-subtle', value: 'neutral-100' },
      { property: 'Radius', token: 'radius/control/md', cssVar: '--radius-control-md', value: '8px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/DateDropdown/index.tsx',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'dropdown (atom)', slug: 'dropdown-atom',
    description: 'Generic dropdown atom (CustomSelect.module.scss only — orphan TSX). Source colors #394150 / #d0d0d0 / #f0f0f0 bound to icon/default / border/default / surface/bg/sunken.',
    variants: ['closed', 'open'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Border', token: 'border/default', cssVar: '--border-default', value: 'neutral-200 (source: #d0d0d0)' },
      { property: 'Arrow', token: 'icon/default', cssVar: '--icon-default', value: 'neutral-700 (source: #394150)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/dropdown/CustomSelect.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'togglebutton', slug: 'toggle-button',
    description: 'CONCENTRATION OF CONFLICTS — 3 DC tickets in this 44-line atom. Source uses #4D3BC2 (DC-008 typo), #4a3fb4 (DC-018 5th brand purple), #7453d7 (= color/course/ai/500 outside its semantic role).',
    variants: ['on', 'off'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/brand', cssVar: '--surface-bg-brand', value: '#722ED1 (DC-005)' },
      { property: 'Text', token: 'text/on/brand', cssVar: '--text-on-brand', value: '#ffffff' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/atoms/togglebutton/togglebutton.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: [
      'DC-008 typo (#4D3BC2) used directly in this atom — codemod target.',
      'DC-018 5th brand purple (#4a3fb4) also present — DC-005 resolution will determine canonical.',
      '#7453d7 = color/course/ai/500 used here outside the AI-course context — semantic-role leak.',
    ],
  },

  // ═══════════════════════════════════════════════════════════════════
  // newDashboard MOLECULES (top 20) — built 2026-04-28
  // ═══════════════════════════════════════════════════════════════════

  {
    name: 'Button (newDashboard)', slug: 'button-nd',
    description: 'NEWDASHBOARD VARIANT — separate from legacy src/components/Button. Verify which is used per page before deprecating either.',
    variants: ['contained', 'outlined'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/brand', cssVar: '--surface-bg-brand', value: '#722ED1' },
      { property: 'Text', token: 'text/on/brand', cssVar: '--text-on-brand', value: '#ffffff' },
      { property: 'Radius', token: 'radius/pill', cssVar: '--radius-pill', value: 'pill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/Button/',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: ['Two parallel Button implementations exist (legacy + newDashboard). Verify per-page usage before deprecating either.'],
  },
  {
    name: 'Input (newDashboard)', slug: 'input-nd',
    description: 'Form input with label + field + helper-text. States: default / focused (border/focus 2px) / error / disabled. Source from Combobox.',
    variants: ['default', 'focused', 'error', 'disabled'],
    tokens: [
      { property: 'Field bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Focus border', token: 'border/focus', cssVar: '--border-focus', value: '#722ED1, 2px' },
      { property: 'Error border', token: 'border/error', cssVar: '--border-error', value: '#FF5C5C' },
      { property: 'Label', token: 'text/muted', cssVar: '--text-muted', value: 'neutral-500' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/Input/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'DropDown (newDashboard)', slug: 'dropdown-nd',
    description: 'Open dropdown panel. Props: open, selected, size, options. Background surface/bg/raised + shadow/md.',
    variants: ['open', 'closed'],
    tokens: [
      { property: 'Panel bg', token: 'surface/bg/raised', cssVar: '--surface-bg-raised', value: '#ffffff' },
      { property: 'Shadow', token: 'shadow/md effect style', cssVar: '—', value: '0 4px 6px -1px rgba(0,0,0,0.1)' },
      { property: 'Radius', token: 'radius/control/lg', cssVar: '--radius-control-lg', value: '10px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/DropDown/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'EmptyState', slug: 'empty-state',
    description: 'Empty state component. Props: variant (no-data / no-internet / error), title, subtitle, optional CTA Button instance.',
    variants: ['no-data', 'no-internet', 'error'],
    tokens: [
      { property: 'Title', token: 'Heading/H4', cssVar: '—', value: 'Nunito 20px / 600' },
      { property: 'Subtitle', token: 'text/muted', cssVar: '--text-muted', value: 'neutral-500' },
      { property: 'Illustration bg', token: 'surface/bg/sunken', cssVar: '--surface-bg-sunken', value: 'neutral-100' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/EmptyState/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'ConfirmationModal', slug: 'confirmation-modal',
    description: 'Modal dialog with title + body + 2 actions. Variants: confirm / danger / info.',
    variants: ['confirm', 'danger', 'info'],
    tokens: [
      { property: 'Overlay', token: 'surface/bg/overlay', cssVar: '--surface-bg-overlay', value: 'rgba(0,0,0,0.5)' },
      ...
      { property: 'Modal shadow', token: 'shadow/xl effect style', cssVar: '—', value: '0 20px 25px -5px rgba(0,0,0,0.1)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/ConfirmationModal/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'BadgesCard', slug: 'badges-card',
    description: 'Achievement badge card. Variants: status (locked / earned / in-progress).',
    variants: ['locked', 'earned', 'in-progress'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Border', token: 'border/subtle', cssVar: '--border-subtle', value: 'neutral-100' },
      { property: 'Badge icon', token: 'surface/bg/accent', cssVar: '--surface-bg-accent', value: '#FFCE00' },
      { property: 'Locked opacity', token: 'opacity/disabled', cssVar: '--opacity-disabled', value: '0.48' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/BadgesCard/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'Card (newDashboard)', slug: 'card-nd',
    description: 'NEWDASHBOARD VARIANT — separate from src/components/Card. Same visual treatment but different code path.',
    variants: ['default'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Border', token: 'border/subtle', cssVar: '--border-subtle', value: 'neutral-100' },
    ...
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/Card/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'ClassCardInfo', slug: 'class-card-info',
    description: 'Class info card with status pill. Variants: status (upcoming / live / completed / cancelled).',
    variants: ['upcoming', 'live', 'completed', 'cancelled'],
    tokens: [
      { property: 'Live bg', token: 'surface/bg/error/subtle', cssVar: '--surface-bg-error-subtle', value: '#FFF0F0' },
      { property: 'Live pill', token: 'surface/bg/error', cssVar: '--surface-bg-error', value: '#FF5C5C' },
      { property: 'Upcoming bg', token: 'surface/bg/brand/subtle', cssVar: '--surface-bg-brand-subtle', value: '#FAF5FF' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/ClassCardInfo/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'Calendar', slug: 'calendar-molecule',
    description: 'Calendar molecule (851 lines in source — most complex molecule in the codebase). Props: view (month/week), selectedDate. Uses 15 distinct hex values in source.',
    variants: ['month', 'week'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Selected day', token: 'surface/bg/brand', cssVar: '--surface-bg-brand', value: '#722ED1' },
      { property: 'Selected text', token: 'text/on/brand', cssVar: '--text-on-brand', value: '#ffffff' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/Calendar/calendar.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: [
      'Largest molecule in the codebase (851 SCSS lines). 15 unique hex values; many unmapped. Tier 4 candidate for full token reconciliation.',
      'Uses #ff2d3a + #ff6e61 (two reds), #fff5dc + #ffe895 (two warm yellows) — none mapped to canonical surface/bg/error or accent.',
    ],
  },
  {
    name: 'AnimatedGems', slug: 'animated-gems',
    description: 'Animated gem reward chip. Props: count, animated. Uses secondary/* tokens for gold theming + animation/scale-in preset.',
    variants: ['static', 'animated'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/accent/subtle', cssVar: '--surface-bg-accent-subtle', value: '#FFFCF5' },
      { property: 'Gem icon', token: 'surface/bg/accent', cssVar: '--surface-bg-accent', value: '#FFCE00' },
      { property: 'Text', token: 'text/accent', cssVar: '--text-accent', value: 'secondary-700' },
      { property: 'Animation', token: 'animation/scale-in', cssVar: '—', value: '200ms ease' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/AnimatedGems/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'DiamondPurchaseHeader', slug: 'diamond-purchase-header',
    description: 'Premium purchase flow header. Props: gemCount, onClose. Brand-purple bg with gem counter + close button.',
    variants: ['default'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/brand', cssVar: '--surface-bg-brand', value: '#722ED1' },
      { property: 'Text', token: 'text/on/brand', cssVar: '--text-on-brand', value: '#ffffff' },
    ...
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/DiamondPurchaseHeader/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'AccountValidityLabel', slug: 'account-validity-label',
    description: 'Subscription status pill. Variants: status (active / expiring / expired).',
    variants: ['active', 'expiring', 'expired'],
    tokens: [
      { property: 'Active bg', token: 'surface/bg/success/subtle', cssVar: '--surface-bg-success-subtle', value: '#E6F8F1' },
      { property: 'Expiring bg', token: 'surface/bg/warning/subtle', cssVar: '--surface-bg-warning-subtle', value: '#FFF5EF' },
      { property: 'Expired bg', token: 'surface/bg/error/subtle', cssVar: '--surface-bg-error-subtle', value: '#FFF0F0' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/AccountValidityLabel/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'EditContactInformation', slug: 'edit-contact-information',
    description: 'Contact info edit form. Props: field (phone/email/name/address), editing. Uses Input atom instances.',
    variants: ['default', 'editing'],
    tokens: [
      { property: 'Field bg', token: 'surface/bg/subtle', cssVar: '--surface-bg-subtle', value: 'neutral-50' },
      { property: 'Card bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/EditContactInformation/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'GetCallBack', slug: 'get-callback',
    description: 'Callback request UI. Props: state (idle/loading/success/error). Uses Button instance for action.',
    variants: ['idle', 'loading', 'success', 'error'],
    tokens: [
      { property: 'Card bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Border', token: 'border/subtle', cssVar: '--border-subtle', value: 'neutral-100' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/GetCallBack/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'ChecklistForJoiningClass', slug: 'checklist-for-joining-class',
    description: 'Pre-class checklist. Props: items, allChecked. Uses ToggleSwitch / Checkbox instances per item.',
    variants: ['partial', 'complete'],
    tokens: [
      { property: 'Checked', token: 'surface/bg/brand', cssVar: '--surface-bg-brand', value: '#722ED1' },
      { property: 'Unchecked', token: 'surface/bg/disabled', cssVar: '--surface-bg-disabled', value: 'neutral-100' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/ChecklistForJoiningClass/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'DiamondReward', slug: 'diamond-reward',
    description: 'Diamond/gem reward chip. Props: amount, type (earned/spent).',
    variants: ['earned', 'spent'],
    tokens: [
      { property: 'Earned bg', token: 'surface/bg/accent/subtle', cssVar: '--surface-bg-accent-subtle', value: '#FFFCF5' },
      { property: 'Spent bg', token: 'surface/bg/error/subtle', cssVar: '--surface-bg-error-subtle', value: '#FFF0F0' },
      { property: 'Text', token: 'text/accent', cssVar: '--text-accent', value: 'secondary-700' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/DiamondReward/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'AddMoreClasses', slug: 'add-more-classes',
    description: 'Upsell card for adding more classes. Variant: inline / modal. Brand-tinted bg + brand title.',
    variants: ['inline', 'modal'],
    tokens: [
      { property: 'Bg', token: 'surface/bg/brand/subtle', cssVar: '--surface-bg-brand-subtle', value: '#FAF5FF' },
      { property: 'Title', token: 'text/brand', cssVar: '--text-brand', value: '#722ED1' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/AddMoreClasses/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'CounsellorCard', slug: 'counsellor-card',
    description: 'Counsellor profile card. Props: name, rating, available. Uses ProfileAvatar + ShowStarRating instances.',
    variants: ['available', 'busy'],
    tokens: [
      { property: 'Card bg', token: 'surface/bg/default', cssVar: '--surface-bg-default', value: '#ffffff' },
      { property: 'Available text', token: 'text/success', cssVar: '--text-success', value: '#00B67A' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/CounsellorCard/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'CardImage', slug: 'card-image',
    description: 'Image display with fallback. Props: src, alt, aspectRatio, fallback. Uses surface/bg/sunken as placeholder.',
    variants: ['default', 'fallback'],
    tokens: [
      { property: 'Placeholder bg', token: 'surface/bg/sunken', cssVar: '--surface-bg-sunken', value: 'neutral-100' },
      { property: 'Radius', token: 'radius/control/lg', cssVar: '--radius-control-lg', value: '10px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/CardImage/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  {
    name: 'ButtonTag', slug: 'button-tag',
    description: 'Toggleable tag/chip. Props: label, selected, size. Selected → surface/bg/brand. Unselected → surface/bg/brand/subtle.',
    variants: ['selected', 'unselected'],
    tokens: [
      { property: 'Selected bg', token: 'surface/bg/brand', cssVar: '--surface-bg-brand', value: '#722ED1' },
      { property: 'Selected text', token: 'text/on/brand', cssVar: '--text-on-brand', value: '#ffffff' },
      { property: 'Unselected bg', token: 'surface/bg/brand/subtle', cssVar: '--surface-bg-brand-subtle', value: '#FAF5FF' },
      { property: 'Unselected text', token: 'text/brand', cssVar: '--text-brand', value: '#722ED1' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/ButtonTag/',
    target: 'newDashboard',
    verificationStatus: 'verified',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════
  // Session 2 Phase 1 — newDashboard molecules (Groups A-H) — 2026-04-28
  // verificationStatus: inferred (source paths confirmed; full token bindings
  // approximated from inventory + spot-checked SCSS, not exhaustive read)
  // ═══════════════════════════════════════════════════════════════════

  // ── Group A — Class + Booking ───────────────────────────────────────

  {
    name: 'SlotPicker', slug: 'slot-picker',
    description: 'Time-slot picker grid for class scheduling. Renders the day strip + time tiles for the selected day, with availability state per tile. Used inside DemoSideBarPopup and the main scheduling flow.',
    variants: ['standalone', 'inside-DemoSideBarPopup'],
    tokens: [
      { property: 'Tile background',    token: 'surface/bg/default',       cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Tile selected bg',   token: 'surface/bg/brand',         cssVar: '--surface-bg-brand',         value: 'DC-005 brand purple' },
      { property: 'Tile padding',       token: 'space/inset/sm',            cssVar: '--space-inset-sm',           value: '12px' },
      { property: 'Tile radius',        token: 'radius/control/md',         cssVar: '--radius-control-md',        value: '8px' },
      { property: 'Day strip gap',      token: 'space/inline/sm',           cssVar: '--space-inline-sm',          value: '8px' },
      { property: 'Disabled overlay',   token: 'color/overlay/white-72',    cssVar: '--color-overlay-white-72',   value: 'white at 72% opacity' },
    ],
    sourceFile: 'repo-cloned/.../src/components/SlotPicker (legacy) + src/newDashboard/components/molecules/DemoSideBarPopup/SlotPicker',
    target: 'newDashboard',
    verificationStatus: 'inferred',
    conflicts: ['Two implementations exist (legacy + DemoSideBarPopup-scoped). Codemod should consolidate.'],
  },
  {
    name: 'SlotSelector', slug: 'slot-selector',
    description: 'Lighter-weight slot picker — single-row carousel of upcoming time slots. Used on cards where space is constrained (e.g. ClassJoiningCard inline).',
    variants: ['inline', 'expanded'],
    tokens: [
      { property: 'Pill background',    token: 'surface/bg/sunken',         cssVar: '--surface-bg-sunken',        value: '#f5f4fa (DC-016)' },
      { property: 'Pill selected bg',   token: 'surface/bg/brand',          cssVar: '--surface-bg-brand',         value: 'DC-005' },
      { property: 'Pill radius',        token: 'radius/pill',               cssVar: '--radius-pill',              value: 'pill' },
      { property: 'Pill padding',       token: 'space/inset/sm',             cssVar: '--space-inset-sm',           value: '8×16' },
    ],
    sourceFile: 'repo-cloned/.../src/components/SlotSelector',
    target: 'sections',
    verificationStatus: 'inferred',
  },
  {
    name: 'ClassesToReschedule', slug: 'classes-to-reschedule',
    description: 'List of upcoming classes available for reschedule, with per-class action button. Composes ReschedulingCard rows.',
    variants: ['empty', 'one-class', 'many-classes'],
    tokens: [
      { property: 'Row padding',        token: 'space/inset/md',            cssVar: '--space-inset-md',           value: '16px' },
      { property: 'Row gap',            token: 'space/stack/sm',            cssVar: '--space-stack-sm',           value: '8px' },
      { property: 'Action button',      token: 'Button / outlined',         cssVar: '—',                          value: 'border + text = brand' },
      { property: 'Brand purple',       token: 'surface/bg/brand',          cssVar: '--surface-bg-brand',         value: '#4e3bc2 (DC-005)' },
      { property: 'Highlight purple',   token: '—',                          cssVar: '—',                          value: '#8a78f9 (DC-015)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/ClassesToReschedule/classesToReschedule.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  ...
  // The class confirmation flow is composed inline inside DemoSideBarPopup.
  {
    ...
    variants: ['default', 'no-upcoming-class', 'in-progress'],
    tokens: [
      ...
      { property: 'Timer pill',         token: 'Timer molecule',             cssVar: '—',                          value: 'mm:ss countdown' },
      { property: 'Join button',        token: 'Button / contained',         cssVar: '—',                          value: 'brand fill' },
      { property: 'Card shadow',        token: 'shadow/sm',                  cssVar: '--shadow-sm',                value: '0 1px 2px rgba(13,29,45,.06)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/templates/FeedLayout/components/ClassJoiningCard',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },

  // ── Group B — Rewards + Gamification ────────────────────────────────

  {
    ...
    tokens: [
      ...
      { property: 'Tile padding',       token: 'space/inset/md',             cssVar: '--space-inset-md',           value: '16px' },
      { property: 'Tile radius',        token: 'radius/card',                cssVar: '--radius-card',              value: '10px' },
      { property: 'Locked overlay',     token: 'color/overlay/white-72',     cssVar: '--color-overlay-white-72',   value: 'white at 72% opacity' },
      { property: 'Cost pill bg',       token: 'surface/bg/accent/subtle',   cssVar: '--surface-bg-accent-subtle', value: 'gold-tinted' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/RedeemGemsCard/RewardCard.tsx',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },
  {
    ...
    tokens: [
      { property: 'Tab bg',             token: 'surface/bg/sunken',          cssVar: '--surface-bg-sunken',        value: '#f5f4fa (DC-016)' },
      { property: 'Active tab bg',      token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Active tab shadow',  token: 'shadow/sm',                  cssVar: '--shadow-sm',                value: '0 1px 2px rgba(13,29,45,.06)' },
  ...
  {
    name: 'MyRewardsCard', slug: 'my-rewards-card',
    description: 'Per-reward card on the "My rewards" tab. Shows reward image, redemption date, gem amount earned. Background uses linear-gradient(105deg, #6851fc 60%, white 40%) — a rare gradient outside marketing surfaces.',
    variants: ['just-redeemed', 'historical'],
    tokens: [
      { property: 'Card bg',            token: '— (linear-gradient)',        cssVar: '—',                          value: 'lg(105deg, #6851fc 60%, white 40%)' },
      { property: 'Gradient seam',      token: '—',                           cssVar: '—',                          value: '#6851fc — DC-022 candidate (Material Design purple variant)' },
      { property: 'Gem pill border',    token: '—',                           cssVar: '—',                          value: '#8a78f9 (DC-015)' },
      { property: 'Card padding',       token: 'space/inset/lg',              cssVar: '--space-inset-lg',           value: '20px' },
      { property: 'Card radius',        token: 'radius/container/lg',         cssVar: '--radius-container-lg',      value: '14px' },
      { property: 'Card shadow',        token: 'shadow/sm',                   cssVar: '--shadow-sm',                value: '$shadow SCSS var' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/MyRewardsCard/myRewardsCard.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: ['Hero gradient #6851fc is a Material-Design-style purple, distinct from DC-005 brand. Surface as DC-022 candidate (MD purple library leak).'],
  },
  {
    name: 'RedeemGemsCard', slug: 'redeem-gems-card',
    description: 'Grid of redeemable rewards on the rewards landing. Composes a header (gem balance + filter) + RewardCard tile grid + redeem CTA. Uses brand purple + DC-015 highlight.',
    variants: ['empty-balance', 'partial', 'all-affordable'],
    tokens: [
      { property: 'Header bg',          token: 'surface/bg/brand',           cssVar: '--surface-bg-brand',         value: 'DC-005 brand purple' },
      { property: 'Header radius',      token: 'radius/container/lg',        cssVar: '--radius-container-lg',      value: '14px' },
      { property: 'Tile gap',           token: 'space/inline/md',             cssVar: '--space-inline-md',          value: '12px' },
      { property: 'Highlight purple',   token: '—',                           cssVar: '—',                          value: '#8a78f9 (DC-015)' },
      { property: 'Redeem CTA',         token: 'Button / contained',          cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/RedeemGemsCard/redeemGemsCard.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },
  {
    name: 'RedeemRewardsModal', slug: 'redeem-rewards-modal',
    description: 'Modal that opens on a reward tile click — shows large image, full description, gem cost, "Confirm redeem" CTA. Standard modal chrome.',
    variants: ['confirm', 'in-flight', 'success', 'error'],
    tokens: [
      { property: 'Modal bg',           token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Modal radius',       token: 'radius/container/xl',        cssVar: '--radius-container-xl',      value: '20px' },
      { property: 'Modal shadow',       token: 'shadow/xl',                  cssVar: '--shadow-xl',                value: 'elevated' },
      { property: 'Scrim',              token: 'color/overlay/dark',          cssVar: '--color-overlay-dark',       value: 'rgba(13,29,45,.50)' },
      { property: 'Confirm CTA',        token: 'Button / contained',          cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/RedeemRewardsModal/redeemRewardsModal.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },
  {
    name: 'RewardsReferralCard', slug: 'rewards-referral-card',
    description: 'Cross-promo card on the rewards landing — "Refer a friend, earn 100 gems". Includes share buttons + recent-referral preview. Inside ReferralSection.',
    variants: ['no-referrals', 'with-referrals'],
    tokens: [
      { property: 'Card bg',            token: 'surface/bg/brand',           cssVar: '--surface-bg-brand',         value: 'DC-005 brand purple' },
      { property: 'Card padding',       token: 'space/inset/lg',             cssVar: '--space-inset-lg',           value: '20px' },
      { property: 'Card radius',        token: 'radius/container/lg',        cssVar: '--radius-container-lg',      value: '14px' },
      { property: 'Text on brand',      token: 'text/on/brand',               cssVar: '--text-on-brand',            value: '#ffffff' },
      { property: 'CTA bg',             token: 'surface/bg/accent',           cssVar: '--surface-bg-accent',        value: 'gold accent' },
    ],
    sourceFile: 'repo-cloned/.../src/components/RewardsReferralCard',
    target: 'sections',
    verificationStatus: 'inferred',
  },
  {
    name: 'RewardsWalkthroughCard', slug: 'rewards-walkthrough-card',
    description: 'First-visit explainer card — "Earn gems by completing classes, redeem for stickers + merch". 3-step illustrated walkthrough with dismiss CTA.',
    variants: ['step-1', 'step-2', 'step-3'],
    tokens: [
      { property: 'Card bg',            token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Step indicator',     token: 'GreenLine / ProgressLine',    cssVar: '—',                          value: 'thin progress dots' },
      { property: 'Card radius',        token: 'radius/container/lg',         cssVar: '--radius-container-lg',      value: '14px' },
      { property: 'Dismiss CTA',        token: 'Button / underline',          cssVar: '—',                          value: 'text-only link style' },
    ],
    sourceFile: 'repo-cloned/.../src/components/RewardsWalkthroughCard',
    target: 'sections',
    verificationStatus: 'inferred',
  },
  {
    name: 'ReferralStatusCard', slug: 'referral-status-card',
    description: 'Per-referral row showing the friend\'s name, signup state (sent / signed-up / paid), and reward eligibility. Listed under the referral hero on /refer-and-earn.',
    variants: ['sent', 'signed-up', 'paid', 'expired'],
    tokens: [
      { property: 'Row bg',             token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Row padding',        token: 'space/inset/md',              cssVar: '--space-inset-md',           value: '16px' },
      { property: 'Row gap',            token: 'space/inline/md',             cssVar: '--space-inline-md',          value: '12px' },
      { property: 'Status pill bg',     token: 'surface/bg/[status]/subtle',  cssVar: '—',                          value: 'success/warning/error/muted by state' },
      { property: 'Status pill radius', token: 'radius/pill',                 cssVar: '--radius-pill',              value: 'pill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/ReferralStatusCard/referralStatusCard.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },

  // ── Group C — Profile + Account ─────────────────────────────────────

  {
    name: 'SwitchProfileItemCard', slug: 'switch-profile-item-card',
    description: 'Compact 40px-wide profile-switch row on the LeftSideBar bottom slot. Shows avatar (31×31, e1ddf5 border), student name, and right chevron. Used in the multi-child account-switcher dropdown.',
    variants: ['default', 'active', 'add-new'],
    tokens: [
      { property: 'Avatar size',        token: 'icon/size/lg',                cssVar: '--icon-size-lg',             value: '31×31 (source-exact)' },
      { property: 'Avatar border',      token: '—',                           cssVar: '—',                          value: '3px solid #e1ddf5 (= primary/350 area)' },
      { property: 'Avatar radius',      token: 'radius/pill',                 cssVar: '--radius-pill',              value: '51% (effectively circle)' },
      { property: 'Row gap',            token: '—',                           cssVar: '—',                          value: '10px (source-exact)' },
      { property: 'Right margin',       token: '—',                           cssVar: '—',                          value: '60px (source-exact, makes room for chevron)' },
    ],
    sourceFile: 'repo-cloned/.../src/components/SwitchProfileItemCard/switchProfileItemCard.module.scss',
    target: 'sections',
    verificationStatus: 'verified',
    conflicts: ['Avatar border #e1ddf5 — close to primary/350 (#e1e2ff) but slightly lavender-shifted. Worth flagging if a primary/350 token migration is planned.'],
  },
  {
    name: 'EditTimezone', slug: 'edit-timezone',
    description: 'Timezone editor — autocomplete dropdown with common timezones at the top, full IANA list below. Composes Skeleton (loading) + DropDown atom + confirm CTA.',
    variants: ['initial', 'editing', 'saving'],
    tokens: [
      { property: 'Dropdown bg',        token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Dropdown radius',    token: 'radius/control/md',           cssVar: '--radius-control-md',        value: '8px' },
      { property: 'Dropdown shadow',    token: 'shadow/lg',                   cssVar: '--shadow-lg',                value: 'floating menu' },
      { property: 'Confirm CTA',        token: 'Button / contained',          cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/EditTimezone',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },

  // ── Group D — Trust + Social ────────────────────────────────────────

  {
    name: 'TrustPilotSidebar', slug: 'trustpilot-sidebar',
    description: 'TrustPilot review sidebar shown on logged-out marketing surfaces (login, signup, pricing). Three-state pattern: 1) review preview, 2) carousel of testimonials, 3) "Read more on TrustPilot" CTA. Heading text uses #0D1D2D × Nunito 32px.',
    variants: ['initial', 'expanded', 'cta'],
    tokens: [
      { property: 'Container bg',       token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Heading',            token: 'font/heading/large + text/default', cssVar: '—',                  value: 'Nunito 32px / 800 / #0D1D2D' },
      { property: 'Section gap',        token: 'space/stack/md',              cssVar: '--space-stack-md',           value: '8-24px varied' },
      { property: 'Section padding',    token: 'space/inset/2xl',             cssVar: '--space-inset-2xl',          value: '32px (horizontal)' },
    ],
    sourceFile: 'repo-cloned/.../src/components/TrustPilotSidebar/trustPilotSidebar.module.scss',
    target: 'sections',
    verificationStatus: 'verified',
  },
  {
    name: 'TrustPilotPopup', slug: 'trustpilot-popup',
    description: 'Standalone TrustPilot review modal. Uses #7453D7 (= AI course color, used here outside its semantic role) and #1E1E1E for near-black text — neither matches DC-014.',
    variants: ['default'],
    tokens: [
      { property: 'Modal bg',           token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Hero accent',        token: 'color/course/ai/500',        cssVar: '--color-course-ai-500',      value: '#7453D7 (used outside AI-course context)' },
      { property: 'Body text',          token: '—',                          cssVar: '—',                          value: '#1E1E1E (DC-014-adjacent variant)' },
      { property: 'Modal radius',       token: 'radius/container/xl',        cssVar: '--radius-container-xl',      value: '20px' },
      { property: 'Modal shadow',       token: 'shadow/xl',                   cssVar: '--shadow-xl',                value: 'elevated' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/TrustPilotPopup/TrustPilotPopup.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
    conflicts: ['#7453D7 is the AI-course color repurposed as a brand accent here — flag if the token must remain course-only.', '#1E1E1E is a near-black variant adjacent to DC-014 (#222a33).'],
  },
  {
    name: 'classRatingFeedback', slug: 'class-rating-feedback',
    description: 'Post-class rating + feedback collector. Composes Rating molecule (star input) + free-text feedback + Submit CTA. Surfaces immediately after a class ends.',
    variants: ['rating-only', 'with-feedback', 'submitted'],
    tokens: [
      { property: 'Modal bg',           token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Star fill',          token: 'surface/bg/accent',          cssVar: '--surface-bg-accent',        value: '#ffc200 (DC-017)' },
      { property: 'Textarea bg',        token: 'surface/bg/sunken',          cssVar: '--surface-bg-sunken',        value: '#f5f4fa (DC-016)' },
      { property: 'Submit CTA',         token: 'Button / contained',          cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/components/classRatingFeedback',
    target: 'sections',
    verificationStatus: 'inferred',
  },
  {
    name: 'ResponsePicker', slug: 'response-picker',
    description: 'Multi-choice answer picker for surveys / polls / NPS. Each option renders as a chip; one selected at a time. Used in post-class feedback + onboarding surveys.',
    variants: ['single-select', 'multi-select'],
    tokens: [
      { property: 'Chip bg',            token: 'surface/bg/sunken',           cssVar: '--surface-bg-sunken',        value: '#f5f4fa' },
      { property: 'Chip selected bg',   token: 'surface/bg/brand',            cssVar: '--surface-bg-brand',         value: 'DC-005' },
      { property: 'Chip text selected', token: 'text/on/brand',                cssVar: '--text-on-brand',            value: '#ffffff' },
      { property: 'Chip radius',        token: 'radius/pill',                  cssVar: '--radius-pill',              value: 'pill' },
      { property: 'Chip gap',           token: 'space/inline/sm',              cssVar: '--space-inline-sm',          value: '8px' },
    ],
    sourceFile: 'repo-cloned/.../src/components/ResponsePicker',
    target: 'sections',
    verificationStatus: 'inferred',
  },

  // ── Group E — Teacher + Counsellor ──────────────────────────────────

  {
    name: 'TeacherDetail', slug: 'teacher-detail',
    description: 'Detailed teacher card — variant of TeacherProfile showing more bio + per-subject ratings. Used inside the teacher-profile section as the hero, and inline in DemoSideBarPopup as a teacher-pick step.',
    variants: ['hero', 'inline-step', 'compact'],
    tokens: [
      { property: 'Card bg',            token: 'surface/bg/raised',           cssVar: '--surface-bg-raised',        value: '#ffffff (raised)' },
      { property: 'Card padding',       token: 'space/inset/lg',               cssVar: '--space-inset-lg',           value: '20px' },
      { property: 'Card shadow',        token: 'shadow/sm',                    cssVar: '--shadow-sm',                value: '0 1px 2px rgba(13,29,45,.06)' },
      { property: 'Avatar size',        token: 'icon/size/2xl',                cssVar: '--icon-size-2xl',            value: '64px' },
      { property: 'Rating star',        token: 'surface/bg/accent',            cssVar: '--surface-bg-accent',        value: 'gold' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/TeacherDetail/teacherDetail.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },

  // ── Group F — Upsell + Marketing (CRITICAL — monetization) ─────────

  {
    name: 'AddMoreClassesV2', slug: 'add-more-classes-v2',
    description: 'CRITICAL upsell flow. Multi-tab purchase surface composing CloseTabFlow / OTSTabContent / SelectCourseComponent / Tabs subcomponents. Drives revenue: every parent who hits this flow has shown intent to buy more classes.',
    variants: ['select-course', 'one-time-special-tab', 'close-tab-flow'],
    tokens: [
      { property: 'Tab bar bg',         token: 'surface/bg/sunken',          cssVar: '--surface-bg-sunken',        value: '#f5f4fa (DC-016)' },
      { property: 'Active tab',         token: 'surface/bg/default',          cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Card padding',       token: 'space/inset/lg',              cssVar: '--space-inset-lg',           value: '20px' },
      { property: 'Card radius',        token: 'radius/container/lg',         cssVar: '--radius-container-lg',      value: '14px' },
      { property: 'CTA',                token: 'Button / contained',          cssVar: '—',                          value: 'brand fill' },
      { property: 'Card shadow',        token: 'shadow/md',                    cssVar: '--shadow-md',                value: 'raised' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/AddMoreClassesV2/addMoreClassesV2.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
    conflicts: ['Composes 4 subcomponents — full token-binding requires reading each one. Inferred values reflect the parent shell only.'],
  },
  {
    name: 'SummerCampCard', slug: 'summer-camp-card',
    description: 'Seasonal campaign card promoting summer camp enrollment. Bright accent palette for vacation programs — typically orange/yellow gradients distinct from brand purple.',
    variants: ['feed-tile', 'sidebar-banner'],
    tokens: [
      { property: 'Card bg',            token: 'surface/bg/accent/subtle',    cssVar: '--surface-bg-accent-subtle', value: 'gold-tinted' },
      { property: 'Card padding',       token: 'space/inset/lg',              cssVar: '--space-inset-lg',           value: '20px' },
      { property: 'Card radius',        token: 'radius/container/lg',          cssVar: '--radius-container-lg',      value: '14px' },
      { property: 'CTA',                token: 'Button / contained',           cssVar: '—',                          value: 'brand or accent' },
    ],
    sourceFile: 'repo-cloned/.../src/components/SummerCampCard',
    target: 'sections',
    verificationStatus: 'inferred',
  },
  {
    name: 'SummerCampBanner', slug: 'summer-camp-banner',
    description: 'Wider summer-camp variant for full-width slots. Distinct from SummerCampCard which is the tile size. Has its own RightSidebar sub-composition for sidebar usage.',
    variants: ['hero-banner', 'sidebar-banner'],
    tokens: [
      { property: 'Banner bg',          token: 'surface/bg/accent/subtle',    cssVar: '--surface-bg-accent-subtle', value: 'gold-tinted' },
      { property: 'Banner padding',     token: 'space/inset/2xl',             cssVar: '--space-inset-2xl',          value: '32px' },
      { property: 'Banner radius',      token: 'radius/container/lg',          cssVar: '--radius-container-lg',      value: '14px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/SummerCampBanner/summerCampBanner.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },
  {
    name: 'UpcomingCertificateCard', slug: 'upcoming-certificate-card',
    description: 'Vertical-rail card on the certificates surface showing the next certificate the student will earn. Distinctive 4px dashed left border + circle indicator — different visual language from the rest of the dashboard.',
    variants: ['locked', 'progress', 'unlocked'],
    tokens: [
      { property: 'Card border-left',   token: '—',                           cssVar: '—',                          value: '4px dashed #fff (source-exact)' },
      { property: 'Card padding-left',  token: '—',                           cssVar: '—',                          value: '21px (source-exact)' },
      { property: 'Indicator circle',   token: '—',                           cssVar: '—',                          value: '20×20, top:-10 left:-11.5 (source-exact)' },
      { property: 'Card margin-top',    token: '—',                           cssVar: '—',                          value: '18px (source-exact)' },
      { property: 'Card padding-bottom', token: 'space/inset/md',             cssVar: '--space-inset-md',           value: '16px' },
      { property: 'Card border-radius', token: '—',                           cssVar: '—',                          value: '3px (source-exact, very small)' },
    ],
    sourceFile: 'repo-cloned/.../src/components/UpcomingCertificateCard/upcomingCertificateCard.module.scss',
    target: 'sections',
    verificationStatus: 'verified',
    conflicts: ['Card uses 3px corner radius — much tighter than radius/control/sm (6px). Border treatment is unique to this card; if reused, file as a new pattern.', 'Hard-coded position offsets (-10, -11.5px) make this card position-sensitive in its layout slot.'],
  },
  {
    name: 'SubscriptionStatusBanner', slug: 'subscription-status-banner',
    description: 'CRITICAL retention banner. Shows current subscription tier + remaining classes + renewal CTA. Sits above DashboardLayout content when subscription state warrants user attention.',
    variants: ['active', 'expiring-soon', 'expired', 'paused'],
    tokens: [
      { property: 'Banner bg',          token: 'surface/bg/[status]/subtle',  cssVar: '—',                          value: 'success / warning / error / muted by state' },
      { property: 'Banner padding',     token: 'space/inset/md',               cssVar: '--space-inset-md',           value: '16px' },
      { property: 'Banner radius',      token: 'radius/container/md',          cssVar: '--radius-container-md',      value: '10px' },
      { property: 'Renew CTA',          token: 'Button / contained',           cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/components/SubscriptionStatusBanner',
    target: 'sections',
    verificationStatus: 'inferred',
  },
  {
    name: 'SubscriptionBanner', slug: 'subscription-banner',
    description: 'Lighter-weight subscription notice — smaller, inline in feeds. Different from SubscriptionStatusBanner: this is informational, not action-blocking. Ships in newDashboard molecules.',
    variants: ['info', 'warning'],
    tokens: [
      { property: 'Banner bg',          token: 'surface/bg/info/subtle',      cssVar: '--surface-bg-info-subtle',   value: 'info-tinted' },
      { property: 'Banner padding',     token: 'space/inset/sm',              cssVar: '--space-inset-sm',           value: '12px' },
      { property: 'Banner radius',      token: 'radius/control/md',            cssVar: '--radius-control-md',        value: '8px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/SubscriptionBanner/subscriptionBanner.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },

  // ── Group G — Demo + Onboarding ─────────────────────────────────────

  {
    name: 'DemoSideBarPopup', slug: 'demo-sidebar-popup',
    description: 'Right-rail sidebar popup that opens during the demo flow. Composes DemoRescheduleClass + SlotPicker + TimeZoneComponent steps. Drives the post-demo follow-up booking funnel.',
    variants: ['reschedule', 'slot-pick', 'timezone-edit'],
    tokens: [
      { property: 'Sidebar bg',         token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Sidebar shadow',     token: 'shadow/lg',                  cssVar: '--shadow-lg',                value: 'elevated rail' },
      { property: 'Section gap',        token: 'space/stack/lg',             cssVar: '--space-stack-lg',           value: '20px' },
      { property: 'Section padding',    token: 'space/inset/lg',             cssVar: '--space-inset-lg',           value: '20px' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/DemoSideBarPopup',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },
  {
    name: 'EditDemoUserForm', slug: 'edit-demo-user-form',
    description: 'Demo-flow form for editing parent + student details before/after a demo class. 9-color palette in source — uses DC-014 + AI course color as form accents.',
    variants: ['parent-section', 'student-section', 'submit-success'],
    tokens: [
      { property: 'Form bg',            token: 'surface/bg/default',         cssVar: '--surface-bg-default',       value: '#ffffff' },
      { property: 'Field bg',           token: 'surface/bg/sunken',          cssVar: '--surface-bg-sunken',        value: '#f5f4fa' },
      { property: 'Field border',       token: 'border/default',              cssVar: '--border-default',           value: 'neutral-200' },
      { property: 'Section header',     token: 'font/heading/medium + text/brand', cssVar: '—',                  value: 'Nunito 18 / 700 / brand purple' },
      { property: 'Submit CTA',         token: 'Button / contained',           cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/EditDemoUserForm/EditDemoUserForm.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
    conflicts: ['Source uses 9 colors including DC-014 (#222a33) and AI course color (#7453D7) as form accents — flag if AI course color is reused outside the AI surface.'],
  },
  {
    name: 'GetCertificateCallBackPreDemo', slug: 'get-certificate-callback-pre-demo',
    description: 'Pre-demo landing card on /demo-dashboard. Pitches a certificate-of-completion + offers a callback CTA. Lead-capture surface for cold demo visitors.',
    variants: ['default'],
    tokens: [
      { property: 'Card bg',            token: 'surface/bg/raised',          cssVar: '--surface-bg-raised',        value: '#ffffff (raised)' },
      { property: 'Card padding',       token: 'space/inset/2xl',             cssVar: '--space-inset-2xl',          value: '32px' },
      { property: 'Card radius',        token: 'radius/container/xl',          cssVar: '--radius-container-xl',      value: '20px' },
      { property: 'Card shadow',        token: 'shadow/md',                    cssVar: '--shadow-md',                value: 'raised' },
      { property: 'CTA',                token: 'Button / contained',           cssVar: '—',                          value: 'brand fill' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/GetCertificateCallBackPreDemo/GetCertificateCallBackPreDemo.module.scss',
    target: 'newDashboard',
    verificationStatus: 'inferred',
  },

  // ── Group H — Sharing + Social ──────────────────────────────────────

  {
    name: 'SharingButtons', slug: 'sharing-buttons',
    description: 'Inline share-action row. Composes EmailSharingButton + FacebookSharingButton + TelegramShareButton + WhatsappSharingButton. WhatsApp uses #25D366 — DC candidate (not in canonical palette).',
    variants: ['inline-row', 'icon-only', 'with-labels'],
    tokens: [
      { property: 'Button gap',         token: 'space/inline/md',             cssVar: '--space-inline-md',          value: '12px' },
      { property: 'Button radius',      token: 'radius/pill',                 cssVar: '--radius-pill',              value: 'pill' },
      { property: 'Icon size',          token: 'icon/size/md',                cssVar: '--icon-size-md',             value: '24px' },
      { property: 'WhatsApp brand',     token: '—',                           cssVar: '—',                          value: '#25D366 (DC candidate — WhatsApp brand color, not BrightChamps token)' },
      { property: 'Facebook brand',     token: '—',                           cssVar: '—',                          value: '#1877F2 (DC candidate — Facebook blue)' },
      { property: 'Telegram brand',     token: '—',                           cssVar: '—',                          value: '#0088CC (DC candidate — Telegram blue)' },
    ],
    sourceFile: 'repo-cloned/.../src/newDashboard/components/molecules/SharingButtons/sharingButton.module.scss',
    target: 'newDashboard',
    verificationStatus: 'verified',
