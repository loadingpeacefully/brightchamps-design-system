...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/foundations/spacing/',   label: 'Spacing',        disabled: true, badge: 'beta' },
      { href: '/foundations/elevation/', label: 'Elevation',      disabled: true, badge: 'beta' },
      { href: '/foundations/radius/',    label: 'Radius',         disabled: true },
      { href: '/foundations/iconography/', label: 'Iconography',  disabled: true, badge: 'beta' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/components/button/',     label: 'Button',         disabled: true },
