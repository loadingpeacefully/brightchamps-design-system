...
const ENTRIES: Entry[] = [
  // 2026-04-29 — v2.8: Running design audit (4 screens) + pending decisions dashboard
  { date: '2026-04-29', version: 'v2.8', kind: 'AUDIT',     title: 'v2.8 — Running design audit: 4 of 35 screens audited (avg 79% match), pending-decisions dashboard live', status: 'shipped', note: 'Audit dashboard at /surfaces/audit-dashboard/. /my-feed 72%, /learn 90%, /badges 84%, /nano-skills 71%. 9 open pending decisions (PD-001 through PD-009) — answer in Slack to unblock.', href: '/surfaces/audit-dashboard/' },
  { date: '2026-04-29', version: 'v2.8', kind: 'DRIFT',     title: '4 new DC tickets — total now 51', status: 'shipped', note: 'DC-048 CRITICAL: Poppins font on /badges chips (third font family). DC-049 magenta+pink feed accents. DC-050 5 grays on one screen. DC-051 electric-blue + coral course-progress accents.', href: '/governance/dc-tickets/' },
  { date: '2026-04-29', version: 'v2.8', kind: 'AUDIT',     title: 'Pending-decisions dashboard at /governance/pending-decisions/ — 9 open questions blocking DS accuracy', status: 'shipped', note: 'PD-001 Montserrat. PD-002 brand purple. PD-003 sidebar 240 vs 80/280. PD-004 #222a33 codemod. PD-005/006 gradients. PD-007 Harvard crimson. PD-008 two-purples-on-one-screen. PD-009 Poppins. Answer in Slack: "PD-XXX: Option Y".', href: '/governance/pending-decisions/' },

  // 2026-04-29 — v2.7: Nano Skills production audit
  { date: '2026-04-29', version: 'v2.7', kind: 'AUDIT',     title: 'v2.7 — Nano Skills design audit: 776 production layers walked, 71% match rate', status: 'shipped', note: 'Compared production frame Final_Dev_Ready_Screens / Nano/Default (10989:8759) against DS library. 11 exact matches, 24 drifts, 10 missing components/tokens, 4 CDN assets. Full diff at /surfaces/nano-skills-audit/. Rebuilt Screen — /nano-skills with production-faithful structure (240px sidebar, ambient blob bg, gradients).', href: '/surfaces/nano-skills-audit/' },
  { date: '2026-04-29', version: 'v2.7', kind: 'DRIFT',     title: '9 new DC tickets filed (DC-039 through DC-047) — total 47 tickets', status: 'shipped', note: 'DC-039 CRITICAL: Montserrat font in production CTAs (DS only ships Nunito). DC-040 sidebar 240px (DS has 80/280). DC-041 DiamondBalanceAlert pattern not in DS. DC-042 #000000 h2 drift. DC-043/DC-044/DC-047 three new gray tokens. DC-045 ambient blob backdrop. DC-046 black active-stroke.', href: '/governance/dc-tickets/' },
  { date: '2026-04-29', version: 'v2.7', kind: 'COMPONENT', title: 'Production audit confirms 5+ live tickets on a single screen — DC-005, DC-008, DC-014, DC-016, DC-034, DC-038', status: 'shipped', note: 'DC-005 four-way brand purple has TWO purple variants on the same screen (#4d3bc2 heading + #6651e4 "View Profile"). DC-014 #222a33 near-black appears 14+ times. Highest-priority codemod targets validated.', href: '/surfaces/nano-skills-audit/#tickets' },

  // 2026-04-29 — v2.6: Visual fidelity pass on Figma screens
  { date: '2026-04-29', version: 'v2.6', kind: 'COMPONENT', title: 'v2.6 — Production gradients applied to Nano Skills screens (Harvard hero, SelfPacedBanner, course tints)', status: 'shipped', note: '10 visual updates: 2 harvard-hero solid purples → linear-gradient(95.77deg, #301172, #5b7cf4). Gray Tier-5 placeholder → SelfPacedBanner gradient (253.85deg, #FFAEC2, #E29ED9, #A86BD1). 7 skill-thumbnails tinted by course color (coding/AI/maths/robotics/finance) since CDN images can\'t be programmatically loaded.', href: '/surfaces/student/#cdn-gap' },
  { date: '2026-04-29', version: 'v2.6', kind: 'DRIFT',     title: 'DC-034 to DC-038 filed — 5 new tickets covering gradients + the CDN asset gap', status: 'shipped', note: 'DC-034 SelfPacedBanner gradient. DC-035 Harvard hero gradient. DC-036 InsufficientDiamonds modal magenta-cyan. DC-037 #8a78f9 diagonal-fade (most-used: 13 occurrences). DC-038 CRITICAL: 765 CDN images can\'t be embedded — manual upload required. Total DC tickets: 38.', href: '/governance/dc-tickets/' },
  { date: '2026-04-29', version: 'v2.6', kind: 'AUDIT',     title: '/surfaces/student/ — new "CDN asset gap" section with priority asset list + URLs', status: 'shipped', note: 'Documents the 8 highest-priority assets (LOGO, avatars, badges, diamonds, harvard logo, BrightBuddy) with their ImageKit CDN paths. Designers upload these manually to fully replicate production screens.', href: '/surfaces/student/#cdn-gap' },
